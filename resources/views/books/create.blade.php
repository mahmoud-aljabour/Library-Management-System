        ...
        <form action="{{ route('books.store') }}" method="POST">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="isbn" id="isbn"
                                ...
                                placeholder="13-digit ISBN" value="{{ old('isbn') }}">
                            @error('isbn')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="page_count" id="page_count"
                                ...
                                placeholder="Page count" value="{{ old('page_count') }}" min="1">
                            @error('page_count')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="edition" id="edition"
                                ...
                                placeholder="Edition" value="{{ old('edition') }}">
                            @error('edition')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="status" id="status"
                                ...
                                <option value="borrowed" @selected(old('status') === 'borrowed')>Borrowed</option>
                            ...
                            <select name="category_ids[]" id="category_ids"
                                ...
                                @foreach ($categories as $category)
                                    <option value="{{ $category->id }}"
                                        @selected(collect(old('category_ids', []))->contains($category->id))>
                                        {{ $category->name }}
                                    </option>
                                @endforeach
                            </select>
            ...
            <div class="card-footer">
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save mr-1"></i> Save Book
                </button>
